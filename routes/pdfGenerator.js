...
class InvoiceGenerator {
  constructor(invoice) {
    // console.log("coming in pdf generator and data", invoice);
    // for (let index = 0; index < invoice.length; index++) {
    //   console.log(invoice[index]);
    // }
    console.log("coming in constructor function ");
    this.invoice = invoice;
  }

  generateHeaders(doc) {
    doc.text("Roznamcha Today", 275, 50).fontSize(20);
  ...
  generate() {
    ...
    console.log("coming in generate function  ");
